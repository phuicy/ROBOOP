...
static const char rcsid[] = "$Id: dynamics.cpp,v 1.35 2007/10/18 16:20:52 gourdeau Exp $";
...
/*!
  ...
  \f$p_i = 
    ...
    \f[
    \dot{v}_{ci} = \dot{v}_i + \dot{\omega}_i \times r_i 
...
/*!
  ...
  \omega_i\times(\omega_i\times r_i) + \dot{v}_i 
  \f]
  \f[
  F_i = m_i \dot{v}_{ci} 
  \f]
